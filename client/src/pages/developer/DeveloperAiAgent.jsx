          ...
          contents: [{
            parts: [{
              text: `You are an AI assistant for a blockchain-based EspeonX platform.
                     ...
                     Available functions: uploadGame, mintNFT, tradeNFT, createTournament, joinTournament, distributePrize, startCrowdfunding, donate, createProposal, transferTokens.
